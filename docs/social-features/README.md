...
- [ ] `v1-follow-profiles-search/02-shared-social-types.md` — Shared schemas + errors for social
- [ ] `v1-follow-profiles-search/03-follow-repository.md` — FollowRepository + Live impl
