...
If you suspect overwatering: stop watering, remove the plant from its pot, and inspect the roots. Brown, mushy roots indicate root rot — see our guide on [how to save a plant from root rot](/en/blog/root-rot-recovery).
