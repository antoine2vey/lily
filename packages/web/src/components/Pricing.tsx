    ...
    <section id="pricing" className="py-24 bg-background">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-2xl mx-auto">
          ...
          <FadeIn className="rounded-3xl p-8 relative text-left" delay={200}>
            <div
            ...
            <div className="relative">
              <span
                className="absolute -top-11 left-1/2 -translate-x-1/2 text-white text-xs font-bold px-4 py-1.5 rounded-full whitespace-nowrap"
                style={{
