...
END $$;
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "user_follows_follower_following_idx" ON "user_follows" USING btree ("follower_id","following_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "user_nudges_from_user_id_idx" ON "user_nudges" USING btree ("from_user_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "user_nudges_to_user_id_idx" ON "user_nudges" USING btree ("to_user_id");
